...
1.  Go to the [**Releases Page**](https://github.com/P1sco/QuestHunter/releases/edit/Win).
...
2.  **Click on Run Replica for the game you want to emulate** corresponding to the game you need to emulate.
