...
** One extra step for source users:** You need to create the `main.mfs` file that the launcher copies to fake app names, rename it to main.mfs and move it to /Binaries/Win64/.
